...
# RDS file
snp_readBed("/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Data/genetic/CD/cd_ukb_allchr.bed")

# RDS file for each chromosome should bein the indir location
q("no")
