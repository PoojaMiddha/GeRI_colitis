# Prepare summary stats from deLange paper as per LDPred2 tutorial (CD)
...
load("/zivlab/data3/pmiddha/Data/sumstats_delange_mrcieu/cd_summary_stats.Rdata")
...
sumstats$n_cases <- as.numeric(12194)
sumstats$n_controls <- as.numeric(28072)
...
#9,443,003 variants to be matched.
#0 ambiguous SNPs have been removed.
#1,017,832 variants have been matched; 0 were flipped and 0 were reversed.
...
jpeg("/zivlab/data3/pmiddha/Data/sumstats_delange_mrcieu/ldpred2_prepare_cd_sumstats_sd.jpeg")
...
saveRDS(sumstats_new, file = "/zivlab/data3/pmiddha/Data/sumstats_delange_mrcieu/ldpred2_cd_sumstats_hapmapmatched.rds") 
