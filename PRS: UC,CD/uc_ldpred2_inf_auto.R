# LDPred2 on UC summary stats already matched with HapMap3 variants to obtain the best PRS 
...
# Load UKB data for UC
obj.bigSNP <- snp_attach("/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Data/genetic/UC/uc_ukb_allchr.rds")
...
# Impute the missing genotype because LDPred2 doesnt work with NA in genotype matrix
...
sumstats <- readRDS("/zivlab/data3/pmiddha/Data/sumstats_delange_mrcieu/ldpred2_uc_sumstats_hapmapmatched.rds")
...
#save(rev2, file = "/zivlab/data3/pmiddha/Data/sumstats_delange_mrcieu/uc_sumstats_reversed_ldpred2.Rdata")
#save(df_beta, file = "/zivlab/data3/pmiddha//Data/sumstats_delange_mrcieu/uc_sumstats_snpmatched_ldpred2.Rdata")

# Compute correlations between variants (Recommendation: 3cM window size)
tmp <- tempfile(tmpdir = "/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Data/genetic/UC/tmp-data")
POS2 <- snp_asGeneticPos(CHR, POS, dir = "/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Data/genetic/UC/tmp-data", 
                         ncores = NCORES)
...
auto <- multi_auto[[1]]
jpeg("/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Results/UC/uc_ldpred2_chain_convergence_fplot.jpeg")
plot_grid(
...
# Store betas
write.csv(beta_inf_snp, file = "/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Results/UC/uc_ldpred2_inf_model.csv", quote = F)
write.csv(final_beta_auto_snp, file = "/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Results/UC/uc_ldpred2_auto_model.csv", quote = F)

# AUC plot
jpeg("/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Results/UC/uc_ldpred2_auto_auc.jpeg")
...
jpeg("/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_UKBB/Results/UC/uc_ldpred2_auto_predicted_caco.jpeg")
ggplot(data.frame(
