...
#SBATCH --output=/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_GeRI/Output/cd_geri_prs_a1_%A_%a.log
...
plink2 \
  ...
  --score $wtpath/cd_ldpred2_auto_model.txt 5 7 8 header list-variants ignore-dup-ids cols=+scoresums \
  --memory 16000 \
  --threads 3 \
  --out $outpath/cd_geri_prs_a1_chr${SLURM_ARRAY_TASK_ID}
