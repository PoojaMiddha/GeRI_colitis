...
#SBATCH --output=/zivlab/data3/pmiddha/Proj_GeRI_GI-irAEs/PRS_GeRI/Output/uc_geri_prs_a0_%A_%a.log
...
plink2 \
  ...
  --score $wtpath/uc_ldpred2_auto_model.txt 4 7 8 header list-variants ignore-dup-ids cols=+scoresums \
  --memory 16000 \
  --threads 3 \
  --out $outpath/uc_geri_prs_a0_chr${SLURM_ARRAY_TASK_ID}
exit
